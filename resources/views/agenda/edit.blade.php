<x-app-layout>
    <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h1 class="h3 fw-bold mb-1">Edit Agenda</h1>
            <div class="text-secondary">Perbarui agenda kegiatan</div>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4 p-lg-5">
            <form method="POST" action="{{ route('agenda.update', $agendaKegiatan) }}">
                @csrf @method('PUT')
                @include('agenda._form', [
                    'agendaKegiatan' => $agendaKegiatan,
                    'jenisAgendas' => $jenisAgendas,
